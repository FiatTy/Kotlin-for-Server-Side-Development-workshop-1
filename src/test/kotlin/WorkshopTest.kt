...
class WorkshopTest {
    ...
    fun `test kilometersToMiles with one kilometer`() {
        ...
        // Assert: ตรวจสอบว่าผลลัพธ์ที่ได้ตรงกับที่คาดหวัง
        assertEquals(expectedMiles, actualMiles, 0.001, "1 km should be 0.621371 mi")
    }
    ...
    fun `test calculateTotalElectronicsPriceOver500`() {
        ...
        val products = listOf(
            ...
            Product("Keyboard", 499.0, "Electronics"), // Price <= 500
        ...
        // Assert: ตรวจสอบว่าผลลัพธ์ที่ได้ตรงกับที่คาดหวัง
        assertEquals(expectedTotal, actualTotal, 0.001, "Electronics over 500 should be price 69300.")
    }
    ...
    fun `test countElectronicsPriceOver500`() {
        ...
        val expectedCount = 4
        // Act: เรียกใช้ฟังก์ชันที่ต้องการทดสอบ
        val actualCount = countElectronicsPriceOver500(products)
        // Assert: ตรวจสอบว่าผลลัพธ์ที่ได้ตรงกับที่คาดหวัง
        assertEquals(expectedCount, actualCount, "Electronics over 500 should be counted 4 times.")
    }
